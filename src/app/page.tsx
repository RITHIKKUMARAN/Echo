    ...
    <div className="flex flex-col w-full relative">
      ...
      <section className="min-h-screen w-full flex items-center justify-center relative p-6 md:p-20 overflow-hidden" id="start">
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            <h1 className="text-[100px] md:text-[180px] font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 leading-[0.9] select-none drop-shadow-lg -ml-4 pb-2 pr-4">
              ECHO
            </h1>
      ...
      <section className="min-h-screen w-full relative py-24 px-4 md:px-0 overflow-hidden bg-slate-50/30" id="features" ref={containerRef}>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-indigo-200/20 rounded-full blur-[80px]" />
          <div className="absolute bottom-[20%] right-[-10%] w-[500px] h-[500px] bg-blue-200/20 rounded-full blur-[80px]" />
        </div>
                    ...
                    <svg className="w-full h-full overflow-visible" viewBox="0 0 100 100" preserveAspectRatio="none">
                      ...
                      <defs>
                        <linearGradient id={`gradient-${index}`} x1="0%" y1="0%" x2="100%" y2="0%">
                          ...
                          <stop offset="50%" stopColor={isEven ? '#6366f1' : '#a855f7'} />
      ...
      <section className="py-20 flex flex-col items-center justify-center relative bg-gradient-to-t from-slate-50 to-transparent" id="end">
        <div className="text-center mb-16 px-6">
          ...
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="px-8 py-4 bg-slate-900 text-white rounded-full font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all flex items-center gap-2 mx-auto">
        ...
        <div className="w-full border-t border-slate-200 mt-auto">
          <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-slate-400 text-[10px] mt-2">© 2025 Echo Platform. All rights reserved.</p>
          </div>
        </div>
      </section>
    </div>
